        ...
        <div className="relative bg-white overflow-hidden pt-20 lg:pt-20">
            <div className="max-w-7xl mx-auto">
                <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                    ...
                    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-4 md:pt-8">
                        <div className="sm:text-center lg:text-left">
                            ...
                            <div className="mt-8 sm:mt-10 sm:flex sm:justify-center lg:justify-start gap-4 space-y-4 sm:space-y-0">
                                <Link
                                    to="/patients"
                                    className="w-full sm:w-auto flex items-center justify-center px-8 py-3.5 border border-transparent text-base font-medium rounded-full text-white bg-gradient-to-r from-primary to-primary-dark hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 md:py-4 md:text-lg md:px-10"
                                >
                                    Get Your Services
                                </Link>
                                <Link
                                    to="/services"
                                    className="w-full sm:w-auto flex items-center justify-center px-8 py-3.5 border-2 border-primary/20 text-base font-medium rounded-full text-primary bg-transparent hover:bg-primary/5 hover:border-primary/40 hover:-translate-y-0.5 transition-all duration-300 md:py-4 md:text-lg md:px-10"
                                >
